...
export const PANELS: Panel[] = [
    ...
    { id: 'projects', title: 'Apps & Projects', icon: ProjectsIcon },
    { id: 'clients', title: 'Clients & Partners', icon: ClientsIcon },
    { id: 'consulting', title: 'Consulting Services', icon: ConsultingIcon },
    { id: 'integrations', title: 'Integrations', icon: IntegrationsIcon },
    { id: 'tax', title: 'Tax & Compliance', icon: TaxIcon },
    { id: 'console', title: 'System Console', icon: ConsoleIcon },
    { id: 'schedule', title: 'Schedule a Call', icon: ScheduleIcon },
    { id: 'contact', title: 'Contact & Identity', icon: ContactIcon },
];
...
export const CLIENTS: Client[] = [
    ...
    {
        name: 'Onsite Property Systems',
        description: 'Property technology and management solutions.',
        url: '#',
        role: 'Brokerage Director / Consultant'
    },
    {
        name: 'Doorman Property Management',
        description: 'Residential property management services.',
        url: '#',
        role: 'Former CEO & Founder'
    }
];
...
export const INITIAL_VENTURES: Venture[] = [
    { id: 'v1', name: 'Puma Malas', url: 'https://www.pumamalas.com', status: 'idle' },
    { id: 'v2', name: 'Sierra Morena Tower', url: 'https://www.sierramorenatower.com', status: 'idle' }
];
