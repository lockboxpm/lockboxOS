...
type Step = 'identity' | 'discovery' | 'upload' | 'analysis' | 'result';
        ...
        <Panel title="~/project_intake_and_analysis">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-8 text-sm font-mono text-slate-500 border-b border-slate-700 pb-4">
                    <span className={step === 'identity' ? 'text-cyan-400 font-bold' : ''}>01. Identity</span>
                    ...
                    <div className="animate-fade-in space-y-6">
                        ...
                        <div className="flex justify-end pt-4">
                            <button 
                                ...
                                className="bg-cyan-600 hover:bg-cyan-700 text-white px-6 py-2 rounded disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
                                Next: Discovery &rarr;
                            </button>
                        </div>
